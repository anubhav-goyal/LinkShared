...
<div id="show-topic" class="content scaffold-show" role="main">
    ...
    <ol class="property-list topic">
        ...
        <g:if test="${topicInstance?.user}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="user-label"><g:link controller="user" action="show"
                                                                                  id="${topicInstance?.user?.id}">${topicInstance?.user?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${topicInstance?.visiblity}">
            <li class="fieldcontain">
                <span id="visiblity-label" class="property-label"><g:message code="topic.visiblity.label"
                                                                             default="Visiblity"/></span>

                <span class="property-value" aria-labelledby="visiblity-label"><g:fieldValue bean="${topicInstance}"
                                                                                             field="visiblity"/></span>
