...
<link rel="apple-touch-icon-precomposed" sizes="144x144"
      href="${resource(dir: "ico", file: "apple-touch-icon-144-precomposed.png")}"/>
<link rel="apple-touch-icon-precomposed" sizes="144x144"
      href="${resource(dir: "ico", file: "apple-touch-icon-114-precomposed.png")}"/>
<link rel="apple-touch-icon-precomposed" sizes="72x72"
      href="${resource(dir: "ico", file: "apple-touch-icon-72-precomposed.png")}"/>
            ...
            <div class="row">
                <div class="col-sm-5">
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-bottom">
                            <form role="form" action="${resource('file': 'j_spring_security_check')}" method="post"
                                  class="login-form">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-bottom">
                            <g:form role="form" controller="user" action="register" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <g:textField name="firstName" placeholder="First name..."
                                                 value="${errorInfo?.firstName}" class="form-first-name form-control"
                                                 id="form-first-name"/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <g:textField name="lastName" placeholder="Last Name..."
                                                 value="${errorInfo?.lastName}" class="form-last-name form-control"
                                                 id="form-last-name"/>
                                </div>

                                <div class="form-group">
                                    <label class="sr-only" for="form-email">Email</label>
                                    <g:textField name="email" placeholder="Email..." value="${errorInfo?.email}"
                                ...
                                <div class="form-group">
                                    ...
                                    <g:textField name="username" placeholder="User name..."
                                                 value="${errorInfo.username}" class="form-user-name form-control"
                                                 id="form-user-name"/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <g:passwordField name="password" placeholder="Password..."
                                                     class="form-password form-control" id="form-password-sign"/>
                                </div>
