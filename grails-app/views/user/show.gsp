	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.resourceRating}">
				<li class="fieldcontain">
					<span id="resourceRating-label" class="property-label"><g:message code="user.resourceRating.label" default="Resource Rating" /></span>
				...
				<g:if test="${userInstance?.subsriptions}">
				<li class="fieldcontain">
					<span id="subsriptions-label" class="property-label"><g:message code="user.subsriptions.label" default="Subsriptions" /></span>
					
						<g:each in="${userInstance.subsriptions}" var="s">
						<span class="property-value" aria-labelledby="subsriptions-label"><g:link controller="subscription" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></span>
						</g:each>
